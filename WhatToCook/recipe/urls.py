...
from .views import GenerateRecipeView, RecipeCreateView, PublishedRecipesView, RecipeSearchView, RecipeDeleteView, RecipeDetailView, RecipeListView

urlpatterns = [
    path('api/recipe/', GenerateRecipeView.as_view(), name='recipe'),
